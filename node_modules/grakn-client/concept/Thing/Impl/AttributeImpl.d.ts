/// <amd-module name="grakn-client/concept/thing/impl/AttributeImpl" />
...
export declare class DoubleAttributeImpl extends AttributeImpl<number> implements Attribute<number> {
    private readonly _value;
    constructor(iid: string, value: number);
...
export declare class StringAttributeImpl extends AttributeImpl<string> implements Attribute<string> {
    private readonly _value;
